...
**Actualizado**: 2026-05-07 (Bloque 55 — History domain audit + AP-27 confirmado sistémico (12 nuevos sites) + pattern fetchMethod switch)
...
### Capa 17 — Reflow audit cross-stack (Bloques 50, 51, 53, 54, 55) — código real producción + dominios cliente↔server
...
### Capa 17 (Bloques 50, 51, 53, 54, 55) — 8 keys
...
**Total actualizado: 126 topic keys** (109 previos + 8 Capa 16 + 7 Capa 17 + 1 re-audit Bloque 50 + 1 app-readable bridge + 1 BQL/yi + 1 BQL Java + 1 User Java + 1 Alarm Bloque 54 + 1 History Bloque 55). Capa 16 CERRADA con cobertura completa de 8 bloques. Capa 17 con corrigendum 50.8 + Bloque 53 SPA-Niagara bridge + Bloque 54 Alarm domain + Bloque 55 History domain + AP-27 RBAC bypass SISTÉMICO confirmado + 20 REST endpoints catalogados + MX60 design backlog 75 entries acumulado.
