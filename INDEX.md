...
**Total actualizado: 119 topic keys** (109 previos + 8 Capa 16 + 2 Capa 17). Capa 16 CERRADA con cobertura completa de 8 bloques (bootstrap+subscriptions+alarms+charts+writes+CSRF cross-frame+RBAC visibility+facets/i18n).
