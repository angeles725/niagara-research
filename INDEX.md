...
**Actualizado**: 2026-05-07 (Bloques 54-56 — Alarm/History/Points domains, AP-27 confirmado sistémico, principio "abstracciones bajas por default" para points)
...
### Capa 17 — Reflow audit cross-stack (Bloques 50, 51, 53-56) — código real producción + dominios cliente↔server
...
### Capa 17 (Bloques 50, 51, 53-56) — 9 keys
...
**Total actualizado: 127 topic keys** (109 previos + 8 Capa 16 + 8 Capa 17 + 1 re-audit Bloque 50 + 1 app-readable bridge + 1 BQL/yi + 1 BQL Java + 1 User Java + 1 Alarm Bloque 54 + 1 History Bloque 55 + 1 Points Bloque 56). Capa 17 con Bloques 53 (SPA bridge) + 54 (Alarm AP-27 + REST) + 55 (History AP-27 sistémico + fetchMethod) + 56 (Points decisión positiva sin wrapper Java) + AP-27 RBAC bypass SISTÉMICO confirmado + 20 REST endpoints catalogados + MX60 design backlog 78 entries acumulado.
