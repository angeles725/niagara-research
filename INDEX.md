...
**Actualizado**: 2026-05-07 (Bloque 54 — Alarm domain client↔server + AP-27 RBAC bypass crítico + corrigendum HTTP REST endpoints + 6 nuevos antipatterns AP-27..32)
...
### Capa 17 — Reflow audit cross-stack (Bloques 50, 51, 53, 54) — código real producción + dominios cliente↔server
...
### Capa 17 (Bloques 50, 51, 53, 54) — 7 keys
...
**Total actualizado: 125 topic keys** (109 previos + 8 Capa 16 + 6 Capa 17 + 1 re-audit Bloque 50 + 1 app-readable bridge + 1 BQL/yi + 1 BQL Java + 1 User Java + 1 Alarm Bloque 54). Capa 16 CERRADA con cobertura completa de 8 bloques (bootstrap+subscriptions+alarms+charts+writes+CSRF cross-frame+RBAC visibility+facets/i18n). Capa 17 con corrigendum 50.8 + Bloque 53 SPA-Niagara bridge + Bloque 54 Alarm domain + AP-27 RBAC bypass crítico + 20 REST endpoints catalogados + MX60 design backlog 73 entries.
