...
| medium | T5 haystack la implementacion completa | decompiled-java | pending (NEXT) |
...
- **read-only-investigable**: **6** (T5-T10) → focus ACTIVO.
- **requires-execution**: 0. **blocked**: 0.
- **Coverage metric**: **4 / 10** (B260-B263). El backlog creció en it.3: +T10 (Brick).
