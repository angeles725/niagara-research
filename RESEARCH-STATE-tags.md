...
| medium | T6 exportTags runtime | decompiled-java | pending (NEXT) |
...
- **read-only-investigable**: **4** (T6, T7, T8, T9) → focus ACTIVO.
- **requires-execution**: 0. **blocked**: 0.
- **Coverage metric**: **6 / 10** (B260-B265). El backlog creció en it.3: +T10 (Brick), cerrado en it.6.
