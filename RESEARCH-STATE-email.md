# RESEARCH-STATE — focus: email (ACTIVE 0/10)
...
block_prefix: niagara-mental-model-bloqueN.md (numeración global; próximo libre: B324)
...
- **Covered blocks**: 318 (corpus-wide, shared-global)
- **Coverage metric**: 1 / 10 closed
- **Last iteration**: 2026-08-04 — E1 closed (BEmailService, B324)
...
| high | E2 BOutgoingAccount — pipeline de envío SMTP: cola memoria/disco, maxSendablePerDay, reset midnight, retry | decompiled-java | pending |
| high | E3 sesión TLS — MailPlatformHandlerSe + BEmailAccount: Properties JavaMail, useSsl vs useStartTls, tlsMinProtocol | decompiled-java | pending |
| medium | E4 lado inbound — BIncomingAccount (POP3/IMAP) + BEmailAlarmAcknowledger (ack por reply-to UUID) | decompiled-java | pending |
