...
| [`00-manual-archival-licensing.md`](00-manual-archival-licensing.md) | Síntesis "archival" en inglés del sistema de licencias como registro de observación (identidad de host, entitlements, autenticidad de módulos, **mapa de decisiones F1–F16 con variaciones de despliegue + índice de trazas forenses**, superficies), con el mismo límite de alcance: describe verificadores existentes, no cómo producirlos ni evadirlos. |
| [`04-quickref-diagnostico-deteccion.md`](04-quickref-diagnostico-deteccion.md) | Quick-reference en inglés ("where to look"): cada fragmento F1–F16 del manual emparejado con señales de reconocimiento, superficie de inspección, look-alikes para desambiguar y respuesta legítima; triage por síntoma + orden de recolección de evidencia. Reconoce estados, no cómo causarlos. |
| [`06-diseno-sistema-licenciamiento-propio.md`](06-diseno-sistema-licenciamiento-propio.md) | **Diseño de un sistema de licenciamiento firmado PROPIO** (esquema REF-License): modelo de amenazas (T1–T7 tomado del pentest), jerarquía de claves, formato de artefacto `REF1`, HostId propio, pipeline all-or-nothing con códigos de error, anti-reloj, blacklist, anti-tampering de módulos, flujo operativo, especificación Java y matriz de aceptación A1–A10. Implementación de referencia: `tools/licensador/licensador.py`. |
| [`05-pentest-evasion-2026-08-01.md`](05-pentest-evasion-2026-08-01.md) | Informe del pentest de evasión del pipeline (SSH + licenciamiento) en la minipc de laboratorio: matrices L-1..L-18bis, veredictos por vía de ataque y recomendaciones de hardening para el OEM. |
