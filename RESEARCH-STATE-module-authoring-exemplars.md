...
status: active (13/14 gaps closed: MAE1-MAE5→B772-B776 + MAE7–MAE14→B778–B785; investigable_open=2 [MAE6 + MAE7-G1]; +1 req-exec MAE1-G1) — MAE6 (B777) is the last, investigador1 (absorbed after companero stalled on a permission prompt)
...
- **Coverage metric**: 13 / 15 investigable gaps closed (~87%). (MAE7-G1 investigable still open; MAE1-G1 req-exec deferred.)
...
- **Coverage metric**: 13 / 15 investigable gaps closed (~87%).
