...
status: active (12/14 gaps closed: MAE1→B772 + MAE2→B773 + MAE3→B774 + MAE4→B775 + MAE7–MAE14→B778–B785; investigable_open=3 incl. MAE7-G1; +1 req-exec MAE1-G1) — MAE5–MAE6 (B776–B777) remain, investigador1 (absorbed after companero stalled on a permission prompt)
...
- **Coverage metric**: 12 / 15 investigable gaps closed (~80%). (MAE7-G1 investigable still open; MAE1-G1 req-exec deferred.)
...
- **Coverage metric**: 12 / 15 investigable gaps closed (~80%).
