...
Coverage: **3/13 gaps closed (J9K-0 bootstrap B657; J9K-1 OS=Linux + J9K-8 SoC=i.MX8M Plus via `[CERT-web]`
Tridium datasheet/FAQ); investigable_open=7, blocked-live=3**. The DOC-answerable read-only surface can be
...
| high | J9K-4 boot-options menu (ESC at boot) | J9 = 2 options (1 Reset platform credentials / 2 Continue) vs J8's 8; Platform Access Recovery shows Host id + Tridium-issued Token — doc-answerable, live-confirmable | pending · investigable (doc) |
