...
gaps_closed: 7 (API1→B507 … API4→B512, API6→B513)
blocks_written: B507–B512, B513 (API6)
...
- **Open gaps — read-only investigable**: **1** (API8 [last, REMITTANCE-check running]).
- **Gaps closed**: 7 (API1→B507 … API4→B512, API6→B513).
