...
- **Métrica**: base **12 / 12 CERRADO** (BG1-BG11 + BG13). **REABIERTO 2026-07-12** (autorizado por usuario) con
  ...
  **D** (pedido usuario 2026-07-12) módulos que usa + sistema de vistas Workbench/navegador. Métrica reapertura: **13 / 16 — A+B+D + BG26/27/28/29/24 (B228-B240). Grupo E casi (falta BG25 schedules). Grupo C PENDIENTE de OK del usuario.**
