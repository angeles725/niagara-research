...
- **Métrica**: base **12 / 12 CERRADO** (BG1-BG11 + BG13). **REABIERTO 2026-07-12** (autorizado por usuario) con
  ...
  **D** (pedido usuario 2026-07-12) módulos que usa + sistema de vistas Workbench/navegador. Métrica reapertura: **4 / 10 (grupo A COMPLETO: B228 auto-binding, B229 floorplans). Sigue grupo B.**
