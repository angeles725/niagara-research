...
**4 / 5 gaps** (C1→B210, C2→B211, C3→B212, C4→B213). ~39 clases (conteo real `find`+`wc`, un solo pipeline
vineflower — lección retro 2026-07-06). B213 disparó **corrección §14 a B211 §211.4** (SelectedWidgets NO
dispara PxSelectionEvent).
...
- **read-only-investigable**: 1 (C5; fuente confirmada alcanzable — chequeo 2026-07-06).
- **requires-execution**: 0. **blocked**: 0.
- **Orden sugerido restante**: C5 (fieldeditors de converters) — último gap.
- **Pre-respuestas parciales** (cerrarán en parte por remisión): C5 verá el cruce `EventUtil`↔`BConverter.TYPE`
  (B210) y los converters CE ya rozados (B198/B202). No surgieron gaps NUEVOS fuera de C1-C5.
