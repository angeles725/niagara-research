...
| **template-wb** | **active (1/5, TW1–TW5)** | `RESEARCH-STATE-template-wb.md` | La capa UI Workbench del subsistema template (`com.tridium.template.ui`, ~65 clases) — deepening de [B200 §200.6] (overview). Motor rt ya cerrado (B577-583). TW1 editores de binding Config+IO (3528 L, sustancial), TW2 import Excel (B200 solo cubrió export), TW3 wizard installapp (13 clases), TW4 Relation editor, TW5 integración .ntpl en WB. Cola detrás de hierarchy; techo honesto ~4 bloques (TW4/TW5 colapsables). REMITTANCE: PxEditor→B191/198, BOG tab→B15, tags→B260-270 | — |
