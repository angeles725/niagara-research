...
|---|---|---|---|---|
| **ports** | **active (0/7, PO-G1–G7)** | `RESEARCH-STATE-ports.md` | Referencia POR-PUERTO de una instalación N4 (station+plataforma): para cada puerto que ESCUCHA — qué es · dónde se configura (qué `BService`) · gate de auth/permiso · qué alcanza (blast-radius). Consolidación+gap-fill; internals de protocolo = REMITTANCE (B398 scan vivo, B134 Fox, B129/B460 daemon, B133/B280 BACnet, B29/B508 web, B476/B498/B503 drivers). Gaps nuevos: exposición/auth por-puerto no consolidada + puertos nunca caracterizados (Modbus :502, SNMP :161 public, BACnet/SC /hub en :443, OPC-UA :52443, Fox multicast, firewall/BServerPort). AUDIT-FIRST 2026-08-29. NEXT PO-G3→B620 | B620– |
