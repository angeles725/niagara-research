...
| **access-control** | **active (0/8, AC1–AC8)** | `RESEARCH-STATE-access-control.md` | El subsistema de AUTORIZACIÓN/RBAC de N4 (users/roles/permissions/categories/password-policy + enforcement/audit) como focus dedicado — el hilo antes DISPERSO (B11 modelo, B30 slot-level, B48 frontend, B341 runAsUser, B398/B490 hardening, B435 WB UI, B494/B510 auth-schemes). AUDIT-FIRST 2026-08-28 (sonnet, verificado inline). ~113 clases; 8 gaps genuinos. AC1 (B558) **corrige B11 §11.3.5** (la enforcement de complejidad SÍ es built-in: `BPasswordStrength`). EXCLUYE por REMITTANCE: auth-scheme SPI (B510), OEM schemes (B494), SCRAM wire (B457), TLS/crypto. NEXT AC1→B558 | B558– |
| **provisioning** | **planned (0/10, PV1–PV10)** | `RESEARCH-STATE-provisioning.md` | El subsistema de FLEET/provisioning `provisioningNiagara` (supervisor→subordinada: Step/Robot model, distribución de software, backup/restore, bootstrap/discovery, credenciales/licencias batch) como focus dedicado — antes DISPERSO (B16, B39 catálogo de 46 steps, B472 backup-over-Fox, B511 BJob, B14 BBatchJobService). AUDIT-FIRST 2026-08-28. 219 clases `-wb` + 48 `-ux` + foundation `batchJob`. 10 gaps genuinos. Queued detrás de access-control. EXCLUYE por REMITTANCE: BJob (B511), join supervisor↔sub (B414-420), backup wire (B472) | — |
