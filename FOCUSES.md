...
| **license-diff** | **planned/bootstrapped (0/6)** | `RESEARCH-STATE-license-diff.md` | Diff LICENCIADA vs SIN-LICENCIA en disco con diffoscope+SHA-256, para documentar qué cambia un license de Niagara en el filesystem. Par: A=Honeywell OptimizerSupervisor **4.14.0.162 licenciada** (3 .license, ya analizada B124-B385) vs B=Tridium EMEA Supervisor **4.15.3.28.2 sin-licencia** (0 .license). CAVEAT 3 EJES: licencia + versión(4.14→4.15) + vendor(Honeywell OEM→Tridium base) — cada hallazgo se atribuye por eje. 6 gaps L1-L6, L1=inventario/clasificación (NEXT). diffoscope 327 en venv del kit | (ninguno aún) |
