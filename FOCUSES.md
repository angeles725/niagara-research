...
|---|---|---|---|---|
| **module-best-practices** | **active (0/6, MBP1–MBP6; bootstrapped 2026-08-30)** | `RESEARCH-STATE-module-best-practices.md` | Guía ACCIONABLE de programación de módulos N4 (rt/ux/wb) destilada de los módulos de referencia (core Tridium + exemplar `httpClientGAngeles` + producción `chihuahua`): buenas estructuras, lógica, anti-patrones, y qué mejorar. DESIGN/síntesis sobre bloques existentes → entregable `docs/module-best-practices.md`. **Ángulo:** NO re-derivar el esqueleto (ya en `module-anatomy`) sino destilar prácticas + recomendaciones. 6 gaps: MBP1 rt · MBP2 ux · MBP3 wb · MBP4 cross-cutting (RBAC/permisos/errores) · MBP5 build/packaging · MBP6 catálogo-exemplar+mejoras+guía. REMITTANCE: module-anatomy B629-636, own-modules-audit B637-647, chihuahua-source B648-655, workbench B427-432. NEXT MBP1→B705. | B705– |
