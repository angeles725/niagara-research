...
| px-editor-core | **active** | `RESEARCH-STATE-px-editor-core.md` | La INFRAESTRUCTURA de pxEditor-wb nombrada-no-abierta — C1 event bus ✅B210, C2 API base ✅B211, C3 factory/WidgetInserter (10), C4 util (EventUtil/Reflector/SelectedWidgets, 7), C5 fieldeditors de converters (3). ~39 clases, fuentes confirmadas. **2/5** | B210– |

## Focus activo

**`px-editor-core` ACTIVO** — arrancado 2026-07-06 (B210). Infra interna de pxEditor-wb. **2/5 gaps**:
C1 (PxEvent bus) ✅B210, C2 (API base root) ✅B211. Siguiente: **C3 (factory/WidgetInserter)**.
Prioridad restante: C3 → C4 (util) → C5 (fieldeditors).
