...
| **kitControl** | **stopped (17/18 closed, investigable=0; síntesis B549)** | `RESEARCH-STATE-kitControl.md` | El eje CONTROL-PROGRAMMING de N4: librería nativa de function blocks (`kitControl`), modelo de writable-point (`javax.baja.control`), módulo `program` (lógica freeform), las REGLAS de cableado (links/ejecución/priority-array) y las librerías de control HVAC (`honeywellFunctionBlocks`, `honIrmControl`, `clHVAC*`). Nace del pedido del operador (docs kitControl + cómo se programan los módulos + reglas + control HVAC). AUDIT-FIRST 2026-08-28. Engine half REMITTANCE (B6/B429); atacó CATALOG+RULES+HVAC-app. CERRADO 2026-08-28/29: KC1–KC16 + KC13-G2 (B536–B557), síntesis B549, §18 retro hecho; KC13-G1 requires-execution cerrado live en B603. Ver `RESEARCH-STATE-kitControl.md` línea 33. | B536–B557, B603 |
