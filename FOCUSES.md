...
| **license-diff** | **stopped (6/6, investigable=0)** | `RESEARCH-STATE-license-diff.md` | Diff LICENCIADA vs SIN-LICENCIA en disco (B386-B391), corrected by live 4.10 addendum B442. Portable verdict: validated HostId-bound `.license` records + runtime feature gates define license state; parent `security/` presence is version-dependent (4.13 unlicensed lacked it, 4.10 unlicensed retains certificate/policy/signing baseline). Modules/bin/config remain vendor/version/user axes. | B386–B391, B442 |
