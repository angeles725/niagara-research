...
| **template** | **active (0/7, T1–T7)** | `RESEARCH-STATE-template.md` | El motor GENÉRICO de templates `com.tridium.template` como focus — el DEEPENING de lo que **[B200] nombró fuera de scope**: `api/impl/*TemplateSource` (T1), `ApplicationTemplateInstaller` (T2), `Mark`/`DeployToComp` de UpgradeUtil (T5), gramática XML del manifest (T3), subtemplates (T4), wire del BTemplateChannel (T6), resolución de TemplateManager + memory scheme (T7). AUDIT-FIRST 2026-08-28. NO re-deriva B200 (amplitud), B573 (wrapper provisioning), ni easyBinding (B36/B81). NEXT T1→B577 | B577– |
