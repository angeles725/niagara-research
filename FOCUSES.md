...
| **framework-drivers** | **planned (0/10, FD1–FD10)** | `RESEARCH-STATE-framework-drivers.md` | Escisión de `oem-honeywell-tail` U12: los módulos DRIVER de framework Tridium (no-OEM) que el corpus lista de pasada pero nunca abrió. AUDIT-FIRST 2026-08-25 (§13). REMITTANCE: `modbus*`=focus modbus B294–B315, SNMP=B476. 10 gaps investigables: opcUaCore (bundling Prosys SDK) + opcUaClient/Server, obixDriver (141 cls), mbus (M-Bus EN13757), openAdr (OpenADR 2.0), opc classic DA (Java tree; nativo=B127), weather, + knxnetIp/abstractMqttDriver (destapados por el audit, fuera de la lista U12 original) | — |
