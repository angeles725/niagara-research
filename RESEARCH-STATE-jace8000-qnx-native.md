...
- **Coverage metric**: 8 / 8 investigable closed (STOPPED)
- **Last iteration**: 2026-08-30 — QN8 closed (B684, security verdict synthesis)
...
| high | QN8 SECURITY VERDICT — consolidate JACE-8000 posture | synthesis | closed (B684 — strong boot/firmware/process, weak data-at-rest: QNX6 partition cleartext, SD=full compromise) |
...
| 8 | 2026-08-30 | QN8 security verdict | B684 | no · inline (synthesis) | 0 (focus STOPPED; QN6-G1 blocked remains) |
...
- **Open gaps — read-only investigable**: 0 → STOP (focus done 8/8)
