<!-- review-status: applied 2026-09-05 · kit e0b701a · shipped: #1 (§8 saturation→application pivot), #3 (§6 obfuscated docSource is a wall), #4 (§3 numeric constants, PR #434), #5 (PROMPT-LOOP peer catch, PR #445), #6 (§19 scratchpad PoC); DISMISSED: #2 ([CERT-a] — §3 ruling, PR #434); DEFERRED: #7 -->
