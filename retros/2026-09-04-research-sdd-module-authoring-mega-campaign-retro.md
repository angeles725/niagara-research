<!-- review-status: applied 2026-09-05 · kit f73f5d6 · PARTIAL — shipped: #2 (PROMPT-LOOP, PR #445 d9be953), #5 (§16 peer-owned dirty tree, PR #427); #4, #6, #8 in PR #434 (§3/§7/§20); DEFERRED: #1, #3, #7 -->
