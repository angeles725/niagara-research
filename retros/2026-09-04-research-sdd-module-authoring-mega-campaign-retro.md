<!-- review-status: applied 2026-09-05 · kit dd552ea · shipped: #1 (§16 census→taxonomy→playbook), #2 (PROMPT-LOOP, PR #445), #3 (§8 bonus block), #4 (§11 numeric constants, PR #434), #5 (§16 peer-owned dirty tree, PR #427), #6 (§7/§20, PR #434), #7 (§18 consuming kit index), #8 (§3/§20, PR #434) -->
