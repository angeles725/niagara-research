<!-- review-status: applied 2026-09-05 · kit 272e1ad · PARTIAL — shipped: #2 (PROMPT-LOOP, PR #445 fe88d17), #5 (§16 peer-owned dirty tree, PR #427), #4, #6, #8 (§3/§7/§20, PR #434); DEFERRED: #1 (§16 census→taxonomy→playbook), #3 (§8 bonus block), #7 (§18 campaign retro checks the consuming kit index) -->
