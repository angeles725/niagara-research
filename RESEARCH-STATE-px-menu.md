...
- **read-only-investigable**: 6 (G2, G3, G10, G11, G4, G12) — TODAS con fuente confirmada
  alcanzable (2026-07-06), `[CERT]`. G5-G9 cerrados (B180-B184). G12 = baja prioridad (refinamiento).
