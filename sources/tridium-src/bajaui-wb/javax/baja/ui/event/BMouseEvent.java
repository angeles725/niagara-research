...
////////////////////////////////////////////////////////////////
  ...
  /**
   * Returns whether the button4 modifier is set.
   * @since Niagara 4.14
   */
  public boolean isButton4Down()
  {
    return (getModifiersEx() & BUTTON4_DOWN_MASK) != 0;
  }

  /**
   * Returns whether the button5 modifier is set.
   * @since Niagara 4.14
   */
  public boolean isButton5Down()
  {
    return (getModifiersEx() & BUTTON5_DOWN_MASK) != 0;
  }
  ...
  public String modifiersToString()
  {
    ...
    if (isButton1Down()) { sb.append(" 1"); }
    if (isButton2Down()) { sb.append(" 2"); }
    if (isButton3Down()) { sb.append(" 3"); }
    if (isButton4Down()) { sb.append(" 4"); }
    if (isButton5Down()) { sb.append(" 5"); }
