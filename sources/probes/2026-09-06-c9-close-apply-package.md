...
## C2. Filed-defect doc-note (no C9 code) — niagara-tools #89
The C9 apply surfaced one KIT lint defect filed OUTSIDE this campaign's code: **niagara-tools #89** — `lint-timers`
companion-flag false positive (pairs a method-LOCAL boolean with a Clock.schedule in a different method; evidence
BDefrostController.java @ a109249 :718 vs :808/:810/:850). Seeded as S21 in `campaign9-research-candidates.md` for C10.
PR12/PR13 close notes carry `#89` as the filed reference; NO C9 code change for it. `[ev: niagara-tools#89]` `[ev: 2026-09-06-c9-kit-ticket-lint-timers-fp.md]`
