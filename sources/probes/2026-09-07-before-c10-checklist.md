# "Before C10" checklist — for Cristian (deploy chain + harness prerequisites)
...
now. `[ev: 2026-09-06-c9-deploy-runbook-delta.md]` `[ev: C9 harness-only pins]`
...
The KIT lint-precision wave: S21 (companion-flag field+same-method), S23 (silent-protection Pattern B surface), S22
(ext-writable per-slot action — after a QA RED re-cut). All WSL-only. See `2026-09-07-c10-lint-refinement-apply-packages.md`.
