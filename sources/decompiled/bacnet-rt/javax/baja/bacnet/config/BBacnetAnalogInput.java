...
public class BBacnetAnalogInput extends BBacnetAnalog {
   public static final Property objectId = newProperty(8, BBacnetObjectIdentifier.make(0), makeFacets(75, 12));
