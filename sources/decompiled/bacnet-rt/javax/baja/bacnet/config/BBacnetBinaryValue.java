...
public class BBacnetBinaryValue extends BBacnetBinary {
   public static final Property objectId = newProperty(8, BBacnetObjectIdentifier.make(5), makeFacets(75, 12));
   public static final Property objectType = newProperty(1, BDynamicEnum.make(5, BEnumRange.make(BBacnetObjectType.TYPE)), makeFacets(79, 9));
