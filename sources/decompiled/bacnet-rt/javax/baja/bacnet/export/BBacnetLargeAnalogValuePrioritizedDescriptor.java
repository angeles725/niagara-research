...
public class BBacnetLargeAnalogValuePrioritizedDescriptor extends BBacnetAnalogWritableDescriptor {
   ...
   public final BFacets getSlotFacets(Slot s) {
      return s == objectId ? BBacnetObjectType.getObjectIdFacets(46) : super.getSlotFacets(s);
   }
