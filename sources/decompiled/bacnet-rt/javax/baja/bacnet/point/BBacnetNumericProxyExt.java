...
@NiagaraType
public class BBacnetNumericProxyExt extends BBacnetProxyExt {
   ...
   public void fromEncodedValue(byte[] encodedValue, BStatus bacnetStatus, Context cx) {
      BStatusNumeric dv = (BStatusNumeric)this.getReadValue().newCopy();
      ...
      try {
               ...
               try {
                  ...
                  switch (tag) {
                     ...
                     case 1:
                        ...
                        dv.setValue(asnIn.readBoolean() ? 1.0 : 0.0);
                        break;
                     case 2:
                        dv.setStatusNull(false);
         ...
         this.readFail(var12.toString());
         this.setLastReadError(ERROR_DEVICE_OTHER);
         if (log.isLoggable(Level.FINE)) {
            log.log(Level.FINE, "Exception decoding value for " + this + ":" + var12, (Throwable)var12);
         }
      }
   }
