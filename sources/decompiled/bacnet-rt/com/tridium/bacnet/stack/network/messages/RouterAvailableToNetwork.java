...
public class RouterAvailableToNetwork extends NetworkLayerMsg {
   private int[] networkNumbers;

   public RouterAvailableToNetwork(ByteArrayInputStream is) throws BacnetStackException {
      super(5);
      this.readNetworkBytes(is);
   }

   public RouterAvailableToNetwork() {
      super(5);
      this.networkNumbers = new int[0];
   }

   public RouterAvailableToNetwork(int networkNumber) {
      super(5);
      this.networkNumbers = new int[]{networkNumber};
   }

   public RouterAvailableToNetwork(int[] networkNumbers) {
      super(5);
   ...
   public String getMsgString() {
      StringBuilder sb = new StringBuilder("RouterAvailableToNetwork; networks=");
