...
public class BAddListElementAction extends BAction {
   public static final Property parameterTypeSpec = newProperty(5, BTypeSpec.NULL, null);
   public static final Type TYPE = Sys.loadType(BAddListElementAction.class);
   ...
   public BValue invoke(BComponent target, BValue arg) {
      if (!(target instanceof BBacnetListOf)) {
         throw new IllegalArgumentException("AddListElement cannot be invoked on " + target.getType());
      } else {
