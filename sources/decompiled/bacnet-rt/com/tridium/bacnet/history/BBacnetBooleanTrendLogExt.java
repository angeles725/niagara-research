...
public class BBacnetBooleanTrendLogExt extends BBacnetBooleanIntervalTrendLogExt {
   ...
   public static final Type TYPE = Sys.loadType(BBacnetBooleanTrendLogExt.class);
   ...
   public void changed(Property p, Context cx) {
      ...
      if (p.equals(interval)) {
         try {
            ...
            log.severe("Point changed, but they change could not be logged.");
         }
      }
   }
   ...
   public void pointChanged(BAbsTime timestamp, BStatusValue out) throws IOException {
      if (this.isCovMode()) {
         ...
         this.writeLastValue(timestamp, out, false);
   ...
   protected boolean isChange(BStatusValue oldValue, BStatusValue newValue) {
      ...
      if (!oldValue.getStatus().equals(newValue.getStatus())) {
         ...
         boolean newBoolean = ((BStatusBoolean)newValue).getValue();
         boolean oldBoolean = ((BStatusBoolean)oldValue).getValue();
