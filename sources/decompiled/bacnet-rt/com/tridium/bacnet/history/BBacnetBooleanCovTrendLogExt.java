...
public class BBacnetBooleanCovTrendLogExt extends BBooleanCovHistoryExt implements BIBacnetTrendLogExt {
   ...
   public static final Type TYPE = Sys.loadType(BBacnetBooleanCovTrendLogExt.class);
         ...
         if (p.equals(enabled)) {
            if (!this.isParentLegal(this.getParent().asComponent())) {
               ...
               try {
                  ...
                  log.severe("Error storing event");
               } finally {
                  this.trigger = false;
               }
            }
   ...
   public void clockChanged(BRelTime shift) throws Exception {
      if (this.getEnabled()) {
         try {
            ...
            logger.severe("Error storing event");
         } finally {
            this.trigger = false;
         }
      }
