...
public class BBacnetEnumIntervalTrendLogExt extends BEnumIntervalHistoryExt implements BIBacnetTrendLogExt {
   ...
   public static final Type TYPE = Sys.loadType(BBacnetEnumIntervalTrendLogExt.class);
