...
public class BDiscoverySchedule extends BStruct {
   ...
   public static final Property scheduleType = newProperty(0, "", null);
   public static final Property description = newProperty(0, "", null);
   public static final Type TYPE = Sys.loadType(BDiscoverySchedule.class);
   ...
   public String getScheduleType() {
      return this.getString(scheduleType);
   }

   public void setScheduleType(String v) {
      this.setString(scheduleType, v, null);
   }
   ...
   public BDiscoverySchedule() {
   }

   public BDiscoverySchedule(String objectName, BBacnetObjectIdentifier objectId, String dataType, String scheduleType) {
