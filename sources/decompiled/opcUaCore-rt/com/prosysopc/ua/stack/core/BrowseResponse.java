...
@TypeDefinitionId("nsu=http://opcfoundation.org/UA/;i=528")
public class BrowseResponse extends AbstractStructure implements ServiceResponse {
   @Deprecated
   public static final ExpandedNodeId BINARY = Ids.BrowseResponse_DefaultBinary;
   @Deprecated
   public static final ExpandedNodeId XML = Ids.BrowseResponse_DefaultXml;
   @Deprecated
   public static final ExpandedNodeId JSON = Ids.BrowseResponse_DefaultJson;
   @Deprecated
   public static final ExpandedNodeId ID = Ids.BrowseResponse;
   public static final StructureSpecification SPECIFICATION;
   private ResponseHeader f_responseHeader;
   private BrowseResult[] f_results;
   private DiagnosticInfo[] f_diagnosticInfos;

   public BrowseResponse() {
   }

   public BrowseResponse(ResponseHeader var1, BrowseResult[] var2, DiagnosticInfo[] var3) {
   ...
   public void setResults(BrowseResult[] var1) {
      this.f_results = var1;
   }
   ...
   public BrowseResponse clone() {
      BrowseResponse var1 = (BrowseResponse)super.clone();
      var1.f_responseHeader = (ResponseHeader)StructureUtils.clone(this.f_responseHeader);
      var1.f_results = (BrowseResult[])StructureUtils.clone(this.f_results);
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         BrowseResponse var2 = (BrowseResponse)var1;
   ...
   public Map<FieldSpecification, Object> toFieldsMap() {
      ...
      var1.put(BrowseResponse.Fields.ResponseHeader, this.getResponseHeader());
      var1.put(BrowseResponse.Fields.Results, this.getResults());
      var1.put(BrowseResponse.Fields.DiagnosticInfos, this.getDiagnosticInfos());
   ...
   public static BrowseResponse.Builder builder() {
      return new BrowseResponse.Builder();
   }

   @Override
   public Object get(FieldSpecification var1) {
      if (BrowseResponse.Fields.ResponseHeader.equals(var1)) {
         return this.getResponseHeader();
      } else if (BrowseResponse.Fields.Results.equals(var1)) {
         return this.getResults();
      } else if (BrowseResponse.Fields.DiagnosticInfos.equals(var1)) {
   ...
   public void set(FieldSpecification var1, Object var2) {
      if (BrowseResponse.Fields.ResponseHeader.equals(var1)) {
         ...
         this.setResults((BrowseResult[])var2);
      } else if (BrowseResponse.Fields.DiagnosticInfos.equals(var1)) {
   ...
   public BrowseResponse.Builder toBuilder() {
      BrowseResponse.Builder var1 = builder();
      var1.setResponseHeader((ResponseHeader)StructureUtils.clone(this.getResponseHeader()));
      var1.setResults((BrowseResult[])StructureUtils.clone(this.getResults()));
   ...
   static {
      ...
      var0.addField(BrowseResponse.Fields.ResponseHeader);
      var0.addField(BrowseResponse.Fields.Results);
      var0.addField(BrowseResponse.Fields.DiagnosticInfos);
      ...
      var0.setName("BrowseResponse");
      var0.setJavaClass(BrowseResponse.class);
      var0.setStructureType(StructureType.NORMAL);
      var0.setBuilderSupplier(BrowseResponse.Builder::new);
   ...
   public static class Builder extends com.prosysopc.ua.stack.utils.AbstractStructure.Builder {
      ...
      public BrowseResponse.Builder setResponseHeader(ResponseHeader var1) {
         this.f_responseHeader = var1;
         return this;
      }
      ...
      public BrowseResponse.Builder setResults(BrowseResult[] var1) {
         this.f_results = var1;
         return this;
      }
      ...
      public BrowseResponse.Builder setDiagnosticInfos(DiagnosticInfo[] var1) {
         this.f_diagnosticInfos = var1;
         return this;
      }
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            ...
            BrowseResponse.Builder var2 = (BrowseResponse.Builder)var1;
            if (!StructureUtils.scalarOrArrayEquals(this.getResponseHeader(), var2.getResponseHeader())) {
               return false;
            } else {
               return !StructureUtils.scalarOrArrayEquals(this.getResults(), var2.getResults())
      ...
      public BrowseResponse.Builder set(FieldSpecification var1, Object var2) {
         if (BrowseResponse.Fields.ResponseHeader.equals(var1)) {
            this.setResponseHeader((ResponseHeader)var2);
            return this;
         } else if (BrowseResponse.Fields.Results.equals(var1)) {
      ...
      public BrowseResponse.Builder clear() {
         super.clear();
         this.f_responseHeader = null;
         this.f_results = null;
         this.f_diagnosticInfos = null;
      ...
      public StructureSpecification specification() {
         return BrowseResponse.SPECIFICATION;
      }

      public BrowseResponse build() {
         return new BrowseResponse(this.f_responseHeader, this.f_results, this.f_diagnosticInfos);
      }
   }

   public static enum Fields implements FieldSpecification {
      ResponseHeader("ResponseHeader", ResponseHeader.class, false, UaIds.ResponseHeader, -1, null, false),
      Results("Results", BrowseResult[].class, false, UaIds.BrowseResult, 1, UaArrayDimensions.valueOf(new long[]{0L}), false),
