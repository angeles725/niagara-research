...
@TypeDefinitionId("nsu=http://opcfoundation.org/UA/;i=534")
public class BrowseNextResponse extends AbstractStructure implements ServiceResponse {
   ...
   public BrowseNextResponse(ResponseHeader var1, BrowseResult[] var2, DiagnosticInfo[] var3) {
   ...
   public BrowseNextResponse clone() {
      BrowseNextResponse var1 = (BrowseNextResponse)super.clone();
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         BrowseNextResponse var2 = (BrowseNextResponse)var1;
   ...
   public Map<FieldSpecification, Object> toFieldsMap() {
      ...
      var1.put(BrowseNextResponse.Fields.ResponseHeader, this.getResponseHeader());
      var1.put(BrowseNextResponse.Fields.Results, this.getResults());
      var1.put(BrowseNextResponse.Fields.DiagnosticInfos, this.getDiagnosticInfos());
   ...
   public static BrowseNextResponse.Builder builder() {
      return new BrowseNextResponse.Builder();
   }

   @Override
   public Object get(FieldSpecification var1) {
      if (BrowseNextResponse.Fields.ResponseHeader.equals(var1)) {
         return this.getResponseHeader();
      } else if (BrowseNextResponse.Fields.Results.equals(var1)) {
         return this.getResults();
      } else if (BrowseNextResponse.Fields.DiagnosticInfos.equals(var1)) {
   ...
   public BrowseNextResponse.Builder toBuilder() {
      BrowseNextResponse.Builder var1 = builder();
   ...
   static {
      ...
      var0.addField(BrowseNextResponse.Fields.ResponseHeader);
      var0.addField(BrowseNextResponse.Fields.Results);
      var0.addField(BrowseNextResponse.Fields.DiagnosticInfos);
      ...
      var0.setName("BrowseNextResponse");
      var0.setJavaClass(BrowseNextResponse.class);
      var0.setStructureType(StructureType.NORMAL);
      var0.setBuilderSupplier(BrowseNextResponse.Builder::new);
   ...
   public static class Builder extends com.prosysopc.ua.stack.utils.AbstractStructure.Builder {
      ...
      public BrowseNextResponse.Builder setResponseHeader(ResponseHeader var1) {
         this.f_responseHeader = var1;
         return this;
      }
      ...
      public BrowseNextResponse.Builder setResults(BrowseResult[] var1) {
         this.f_results = var1;
         return this;
      }
      ...
      public BrowseNextResponse.Builder setDiagnosticInfos(DiagnosticInfo[] var1) {
         this.f_diagnosticInfos = var1;
         return this;
      }
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            ...
            BrowseNextResponse.Builder var2 = (BrowseNextResponse.Builder)var1;
            if (!StructureUtils.scalarOrArrayEquals(this.getResponseHeader(), var2.getResponseHeader())) {
               return false;
            } else {
               return !StructureUtils.scalarOrArrayEquals(this.getResults(), var2.getResults())
      ...
      public BrowseNextResponse.Builder set(FieldSpecification var1, Object var2) {
         if (BrowseNextResponse.Fields.ResponseHeader.equals(var1)) {
            this.setResponseHeader((ResponseHeader)var2);
            return this;
         } else if (BrowseNextResponse.Fields.Results.equals(var1)) {
      ...
      public BrowseNextResponse.Builder clear() {
         super.clear();
         this.f_responseHeader = null;
         this.f_results = null;
         this.f_diagnosticInfos = null;
      ...
      public StructureSpecification specification() {
         return BrowseNextResponse.SPECIFICATION;
      }

      public BrowseNextResponse build() {
         return new BrowseNextResponse(this.f_responseHeader, this.f_results, this.f_diagnosticInfos);
      }
   }
