...
@TypeDefinitionId("nsu=http://opcfoundation.org/UA/;i=674")
public class WriteResponse extends AbstractStructure implements ServiceResponse {
   @Deprecated
   public static final ExpandedNodeId BINARY = Ids.WriteResponse_DefaultBinary;
   @Deprecated
   public static final ExpandedNodeId XML = Ids.WriteResponse_DefaultXml;
   @Deprecated
   public static final ExpandedNodeId JSON = Ids.WriteResponse_DefaultJson;
   @Deprecated
   public static final ExpandedNodeId ID = Ids.WriteResponse;
   public static final StructureSpecification SPECIFICATION;
   private ResponseHeader f_responseHeader;
   private StatusCode[] f_results;
   private DiagnosticInfo[] f_diagnosticInfos;

   public WriteResponse() {
   }

   public WriteResponse(ResponseHeader var1, StatusCode[] var2, DiagnosticInfo[] var3) {
   ...
   public void setResults(StatusCode[] var1) {
      this.f_results = var1;
   }
   ...
   public WriteResponse clone() {
      WriteResponse var1 = (WriteResponse)super.clone();
      var1.f_responseHeader = (ResponseHeader)StructureUtils.clone(this.f_responseHeader);
      var1.f_results = (StatusCode[])StructureUtils.clone(this.f_results);
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         WriteResponse var2 = (WriteResponse)var1;
   ...
   public Map<FieldSpecification, Object> toFieldsMap() {
      ...
      var1.put(WriteResponse.Fields.ResponseHeader, this.getResponseHeader());
      var1.put(WriteResponse.Fields.Results, this.getResults());
      var1.put(WriteResponse.Fields.DiagnosticInfos, this.getDiagnosticInfos());
   ...
   public static WriteResponse.Builder builder() {
      return new WriteResponse.Builder();
   }

   @Override
   public Object get(FieldSpecification var1) {
      if (WriteResponse.Fields.ResponseHeader.equals(var1)) {
         return this.getResponseHeader();
      } else if (WriteResponse.Fields.Results.equals(var1)) {
         return this.getResults();
      } else if (WriteResponse.Fields.DiagnosticInfos.equals(var1)) {
   ...
   public void set(FieldSpecification var1, Object var2) {
      if (WriteResponse.Fields.ResponseHeader.equals(var1)) {
         ...
         this.setResults((StatusCode[])var2);
      } else if (WriteResponse.Fields.DiagnosticInfos.equals(var1)) {
   ...
   public WriteResponse.Builder toBuilder() {
      WriteResponse.Builder var1 = builder();
      var1.setResponseHeader((ResponseHeader)StructureUtils.clone(this.getResponseHeader()));
      var1.setResults((StatusCode[])StructureUtils.clone(this.getResults()));
   ...
   static {
      ...
      var0.addField(WriteResponse.Fields.ResponseHeader);
      var0.addField(WriteResponse.Fields.Results);
      var0.addField(WriteResponse.Fields.DiagnosticInfos);
      ...
      var0.setName("WriteResponse");
      var0.setJavaClass(WriteResponse.class);
      var0.setStructureType(StructureType.NORMAL);
      var0.setBuilderSupplier(WriteResponse.Builder::new);
   ...
   public static class Builder extends com.prosysopc.ua.stack.utils.AbstractStructure.Builder {
      ...
      public WriteResponse.Builder setResponseHeader(ResponseHeader var1) {
         this.f_responseHeader = var1;
         return this;
      }
      ...
      public WriteResponse.Builder setResults(StatusCode[] var1) {
         this.f_results = var1;
         return this;
      }
      ...
      public WriteResponse.Builder setDiagnosticInfos(DiagnosticInfo[] var1) {
         this.f_diagnosticInfos = var1;
         return this;
      }
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            ...
            WriteResponse.Builder var2 = (WriteResponse.Builder)var1;
            if (!StructureUtils.scalarOrArrayEquals(this.getResponseHeader(), var2.getResponseHeader())) {
               return false;
            } else {
               return !StructureUtils.scalarOrArrayEquals(this.getResults(), var2.getResults())
      ...
      public WriteResponse.Builder set(FieldSpecification var1, Object var2) {
         if (WriteResponse.Fields.ResponseHeader.equals(var1)) {
            this.setResponseHeader((ResponseHeader)var2);
            return this;
         } else if (WriteResponse.Fields.Results.equals(var1)) {
      ...
      public StructureSpecification specification() {
         return WriteResponse.SPECIFICATION;
      }

      public WriteResponse build() {
         return new WriteResponse(this.f_responseHeader, this.f_results, this.f_diagnosticInfos);
      }
   }

   public static enum Fields implements FieldSpecification {
      ResponseHeader("ResponseHeader", ResponseHeader.class, false, UaIds.ResponseHeader, -1, null, false),
      Results("Results", StatusCode[].class, false, UaIds.StatusCode, 1, UaArrayDimensions.valueOf(new long[]{0L}), false),
