...
@NiagaraSingleton
public class BFoxsScheme extends BStationSessionScheme {
   ...
   public OrdQuery parse(String queryBody) {
      return new BFoxsScheme.FoxQuery(queryBody);
   }
   ...
   public OrdTarget resolve(OrdTarget base, OrdQuery query, AuthenticationClient client) throws SyntaxException, UnresolvedException {
      ...
      BFoxsScheme.FoxQuery foxQuery = (BFoxsScheme.FoxQuery)query;
