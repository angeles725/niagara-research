...
public class ExEnumerateAddressRequest extends ExNetMgmtCommand {
   private int index = 0;

   public ExEnumerateAddressRequest(int addrIndex) {
      this.code = 112;
      this.setAppCommand(38);
      this.setResource(3);
      this.setIndex(addrIndex);
   }
   ...
   public LonMessage toSuccessMessage(LonInputStream in) throws LonException {
      return new ExEnumerateAddressResponse(in);
   }
}
