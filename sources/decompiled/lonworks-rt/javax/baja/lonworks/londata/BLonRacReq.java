...
public class BLonRacReq extends BLonData {
   ...
   public static final Property addrInitLocation = newProperty(
      0, BLonFloat.DEFAULT, LonFacetsUtil.makeFacets(BLonElementType.ub, false, 0.0F, true, 8.0F, 1.0F, 0.0F, true, 2, 0, false, 0.0F, 4, null)
   );
   ...
   public BLonBoolean getDestDef() {
      return (BLonBoolean)this.get(destDef);
   }

   public void setDestDef(BLonBoolean v) {
      this.set(destDef, v, null);
   }
   ...
   public void toOutputStream(LonOutputStream out) {
      this.primitiveToOutputStream(destDef, out);
   ...
   public void fromInputStream(LonInputStream in) {
      this.primitiveFromInputStream(destDef, in);
